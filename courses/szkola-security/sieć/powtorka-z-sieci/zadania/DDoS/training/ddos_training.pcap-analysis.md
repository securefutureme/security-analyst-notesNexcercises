...
Zerknijmy teraz na Packet Lenghts:  
![alt](Pastedimage20260331115314.png)
...
W Netflow nie ma narzędzia do robienia grafów, jak w Wiresharku. Za to możemy przekonwertować nfcapd do csv i potem wykres zrobić w Excelu. Zrobimy to komendą:  
...
#### Wireshark
Do tego użyjemy opcji **Statstics - > I/O Graph.**

Filtrujemy IP’kami które brały udział w ataku **ip.addr == (IP ATAKUJĄCEGO) && ip.addr == (IP OFIARY)**
...
Eliminując IP ofiary i atakujących, (oraz takie jak 8.8.8.8 (google DNS), 255.255.255.255 (adres broadcast) oraz 0.0.0.0 (adres specjalny lub do konfigu) mamy:  
