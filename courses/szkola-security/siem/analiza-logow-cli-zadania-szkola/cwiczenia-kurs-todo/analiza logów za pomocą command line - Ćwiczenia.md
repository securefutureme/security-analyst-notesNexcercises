...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/1-image.png)
...
![alt|697](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/2-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/3-image.png)

Odp. **Format: *apache combined* - na końcu ma Referrer i User-Agent w cudzysłowaćh**
https://httpd.apache.org/docs/2.4/logs.html

![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/4-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/5-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/7-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/8-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/9-image.png)

Albo czy techniki SQLi pojawiły się w krótkim czasie:

![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/10-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/11-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/12-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/13-image.png)

**Odp. 7.1KB.

2. **Jaki zakres czasu jest zawarty w logach?** 
   
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/14-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/15-image.png)
**format apache combined - kopia access.log**

4. Ile i jakie adresy IP wysyłały żądania do aplikacji webowej w analizowanym zakresie czasu? 

![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/16-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/17-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/18-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/19-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/20-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/21-image.png)

**Odp. **Size: 11706 - 12 K**

2. Jaki zakres czasu jest zawarty w logach? 

![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/23-image.png)

Odp. **24/May/2022:08:11:21 +0200 do 24/May/2022:09:52:03 +0200**

3. W jakim forcie jest plik logów oraz, którego pliku jest kopią? 

![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/25-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/26-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/25-image.png)
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/27-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/22-image.png)
...
![alt](courses/szkola-security/siem/analiza-logow-cli-zadania-szkola/cwiczenia-kurs-todo/Attachments/29-image.png)
