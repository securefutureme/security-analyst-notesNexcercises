...
![alt](/courses/szkola-security/secuirty-analyst/kodowanie-hashowanie-szyfrowanie/zadania-szkola/Attachments/image-56.png)

- nastepnie zapisujemy do pliku (najpierw usuwamy początek "powershell -enc")

![alt](/courses/szkola-security/secuirty-analyst/kodowanie-hashowanie-szyfrowanie/zadania-szkola/Attachments/image-58.png)

- otwieramy plik w nowej karcie, i tak samo ucinamy końcówkę (albo używamy Regural expressions).

![alt](/courses/szkola-security/secuirty-analyst/kodowanie-hashowanie-szyfrowanie/zadania-szkola/Attachments/image-57.png)

- kontynuujemy "zapętlanie" aż wyskoczy nam wynik (sekwencja tutaj się powtarza)

![alt](/courses/szkola-security/secuirty-analyst/kodowanie-hashowanie-szyfrowanie/zadania-szkola/Attachments/image-59.png)
...
![alt](/courses/szkola-security/secuirty-analyst/kodowanie-hashowanie-szyfrowanie/zadania-szkola/Attachments/image-60.png)
...
![alt](/courses/szkola-security/secuirty-analyst/kodowanie-hashowanie-szyfrowanie/zadania-szkola/Attachments/1-image.png)
...
![alt](/courses/szkola-security/secuirty-analyst/kodowanie-hashowanie-szyfrowanie/zadania-szkola/Attachments/2-image.png)
...
![alt](/courses/szkola-security/secuirty-analyst/kodowanie-hashowanie-szyfrowanie/zadania-szkola/Attachments/3-image.png)
